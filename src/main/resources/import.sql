insert into Customer (username, name) values ('javier', 'Javier')
insert into Customer (username, name) values ('claudia', 'Claudia')
insert into Customer (username, name) values ('gabriel', 'Gabriel')
